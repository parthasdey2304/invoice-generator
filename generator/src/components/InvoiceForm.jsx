  ...
  return (
    <div className={`p-2 transition-colors duration-300 ${isDarkTheme ? 'dark:bg-gray-900' : 'bg-white'}`}>
      <div className="fixed top-4 right-4 flex items-center">
        {showMessage && (
          <span className="mr-4 text-xl font-['Poppins'] font-medium text-gray-700 dark:text-gray-700 animate-bounce">
      ...
      <h1 className={`text-center text-5xl font-bold py-10 ${isDarkTheme ? 'text-white' : 'text-gray-800'}`}>
        Invoice Generator
      </h1>
